            ...
            <div className="p-6">
                ...
                <div className="flex items-center space-x-4 mb-6 pb-4 border-b border-primary/30">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      ...
                      {lastAddedItem.size && ` • Size: ${lastAddedItem.size}`}
                    </p>
                    <p className="text-sm font-bold text-primary mt-1">
                      ₹{((lastAddedItem.price || 0) * (lastAddedItem.quantity || 1)).toLocaleString('en-IN')}
                    </p>
                  </div>
                </div>
              )}
              ...
              <div className="space-y-2">
                <button
                  ...
                  className="w-full px-6 py-2.5 border-2 border-primary text-primary bg-white font-semibold rounded-full hover:bg-primary hover:text-white transition-all duration-300 shadow-sm hover:shadow-md"
                >
                  VIEW CART
                </button>
                <button
                  onClick={handleCheckout}
                  className="w-full px-6 py-2.5 bg-primary text-white font-semibold rounded-full hover:bg-secondary transition-all duration-300 shadow-md hover:shadow-lg"
                >
                  CHECKOUT
                </button>
              </div>
